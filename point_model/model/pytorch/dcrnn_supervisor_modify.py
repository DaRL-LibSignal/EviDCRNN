...
from model.pytorch.loss import masked_mae_loss,masked_mse_loss
...
class DCRNNSupervisor:
    ...
    def evaluate(self, dataset='val', batches_seen=0):
        ...
        with torch.no_grad():
            ...
            return loss_mse,loss_rmse,loss_mae
    ...
    def _train(self, base_lr,
        ...
        for epoch_num in range(self._epoch_num, epochs):
            ...
            """
            print("train_time = %.4lf" % (end_train_time - start_train_time))

            if (epoch_num % test_every_n_epochs) == test_every_n_epochs - 1:
                start_test_time = time.time()
                test_mse,test_rmse,test_mae= self.evaluate(dataset='test', batches_seen=batches_seen)
                end_test_time = time.time()
                message = 'Epoch [{}/{}] ({}) test_mae:{:.4f}, test_mse: {:.4f}, test_rmse: {:.4f} , ' \
