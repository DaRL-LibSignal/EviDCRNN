...
class DCRNNSupervisor:
    ...
    def _train(self, base_lr,
        ...
        for epoch_num in range(self._epoch_num, epochs):
            ...
            for _, (x, y) in enumerate(train_iterator):
                ...
                loss ,reg_loss= self._compute_loss(gamma, nu, alpha, beta,y)
            ...
            if (epoch_num % log_every) == log_every - 1:
                ...
                message = 'Epoch [{}/{}] ({}) val_mae:{:.4f}, val_mis: {:.4f}, val_width: {:.4f}, val_mse: {:.4f}, val_rmse: {:.4f} , ' \
                          'train_time{:.1f}s'.format(epoch_num, epochs, batches_seen,
            ...
            if (epoch_num % test_every_n_epochs) == test_every_n_epochs - 1:
                ...
                message = 'Epoch [{}/{}] ({}) test_mae:{:.4f},test_mis: {:.4f}, test_width: {:.4f}, test_mse: {:.4f}, test_rmse: {:.4f} , lambda: {:.4f} ' \
                          'test_time{:.1f}s'.format(epoch_num, epochs, batches_seen,
                                           test_mae,test_mis,test_width ,test_mse,test_rmse,self.lambda_coef
    ...
    def _compute_loss(self, gamma, nu, alpha, beta,y_true):
        ...
        return edl_loss(gamma,nu,alpha,beta, y_true,self.lambda_coef)
    ...
    def compute_mis(self, gamma, nu, alpha, beta,y_true):
        ...
        beta = self.standard_scaler.inverse_transform(beta)
        y_true = self.standard_scaler.inverse_transform(y_true)
        return student_t_mis(gamma,nu,alpha,beta,y_true)
    def compute_width(self, gamma, nu, alpha, beta,y_true):
        ...
        beta = self.standard_scaler.inverse_transform(beta)
        y_true = self.standard_scaler.inverse_transform(y_true)
        return width(gamma, nu, alpha, beta, y_true)
